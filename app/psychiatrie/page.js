  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="text-center py-12 bg-blue-100">
        <h1 className="text-4xl font-bold text-[#0b263d]">Suivi Psychatriques - Dépression et Anxiété</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-[#46a2c3] p-6 rounded-lg">
        ...
        <div className="mt-6">
          <button
            type="submit"
            className="px-12 py-4 bg-[#157291] text-white font-semibold rounded-lg hover:bg-[#7fc6a4] hover:text-black transition-colors"
          >
            Soumettre
          </button>
        </div>
